# คู่มือการปฏิบัติงาน (Playbook): Financial Model Updating post-earnings

**Target แผนก:** Wealth & Trading
**ตัวเชื่อมโยงระบบที่จำเป็น (Required Connectors):** S&P Global, FactSet, Claude for Excel
