...
CREATE TABLE IF NOT EXISTS audit_log (
  id         BIGSERIAL PRIMARY KEY,
  event_type TEXT NOT NULL, -- see migration 002 for CHECK constraint + taxonomy
  source_ip  TEXT,
  source     TEXT,
  payload    JSONB,
  timestamp  TIMESTAMPTZ DEFAULT NOW()
