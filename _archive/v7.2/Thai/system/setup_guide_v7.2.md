...
> ไฟล์ต้นฉบับ: `English/system/setup_guide_v7.2.md` | อัพเดตล่าสุด: 2026-05-30 04:32
...
### 3.1 สร้าง Jeff เอเจนต์
1. Dify.ai → Studio → + Create → เอเจนต์
2. ชื่อ: `Jeff`
...
### 3.2 สร้าง Eilinaire เอเจนต์
1. ชื่อ: `Eilinaire เอเจนต์`
2. Model: GPT-4o
...
### 3.3 สร้าง Ego Era เอเจนต์
1. ชื่อ: `Ego Era เอเจนต์`
...
4. Nodes ที่ต้องสร้าง (ลากตามลำดับ):
   ...
   - [IF: HITL needed?] → [HTTP: n8n webhook หรือ เอเจนต์ routing]
...
[IF: hitl_required == true]
    ↓ (true)              ↓ (false)
[LINE: ✋ ขออนุมัติ]   [HTTP: Dify เอเจนต์]
[Wait: 24h]               ↓
...
| ปัญหา | วิธีแก้ |
|---|---|
| LINE ไม่ตอบ | ตรวจ Webhook URL ใน LINE Console + n8n Workflow ทำงานอยู่? |
