...
7. **Background Sync Offloading:** Do NOT manually translate files to `Thai/` or update `master_context.md` during execution. These are handled asynchronously by the background sync Python daemon (`sync_daemon.py`).
