...
| Channel | Purpose |
|---------|---------|
| #coprem-inbox | Main task input — Prem types commands here |
| #coprem-alerts | Critical errors, cost spikes, HITL pending, DLQ warnings |
| #coprem-staging | Test new workflows before production |
| #coprem-feedback | Rate outputs ⭐1–5 |
| #coprem-library | Read EGO ERA chapters generated by agent |

**Bot permissions required:** `Send Messages`, `Read Message History`, `Use Slash Commands`, `Manage Webhooks`
